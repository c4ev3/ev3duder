...
\item 
void $\ast$ \hyperlink{btserial_8h_a9d1ed570025eb554c752cea2bf974251}{bt\+\_\+open} (const char $\ast$file\+\_\+in, const char $\ast$file\+\_\+out)
...
\subsubsection[{bt\+\_\+close(void $\ast$)}]{\setlength{\rightskip}{0pt plus 5cm}void bt\+\_\+close (
...
\subsubsection[{bt\+\_\+error(void $\ast$device)}]{\setlength{\rightskip}{0pt plus 5cm}const wchar\+\_\+t$\ast$ bt\+\_\+error (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{fd\+\_\+}
\end{DoxyParamCaption}
...
\end{DoxySeeAlso}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000009}{Bug}]it\textquotesingle{}s useless \end{DoxyRefDesc}



\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em device} & handle returned by \hyperlink{bt-win_8c_a4926e3ba996c4e77d68845713a09db0c}{bt\+\_\+open()} \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
message An error string
...
\hypertarget{btserial_8h_a9d1ed570025eb554c752cea2bf974251}{}\index{btserial.\+h@{btserial.\+h}!bt\+\_\+open@{bt\+\_\+open}}
\index{bt\+\_\+open@{bt\+\_\+open}!btserial.\+h@{btserial.\+h}}
\subsubsection[{bt\+\_\+open(const char $\ast$file\+\_\+in, const char $\ast$file\+\_\+out)}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ bt\+\_\+open (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{device, }
\item[{const char $\ast$}]{unused}
\end{DoxyParamCaption}
)}\label{btserial_8h_a9d1ed570025eb554c752cea2bf974251}
...
\subsubsection[{bt\+\_\+read(void $\ast$device, u8 $\ast$buf, size\+\_\+t count, int milliseconds)}]{\setlength{\rightskip}{0pt plus 5cm}int bt\+\_\+read (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{handle, }
\item[{{\bf u8} $\ast$}]{buf, }
\item[{size\+\_\+t}]{count, }
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000008}{Bug}]the milliseconds part needs to be tested more throughly \begin{DoxySeeAlso}{See also}
implementation at \hyperlink{bt-win_8c}{bt-\/win.\+c} and \hyperlink{bt-unix_8c}{bt-\/unix.\+c} 
\end{DoxySeeAlso}
\end{DoxyRefDesc}
...
\subsubsection[{bt\+\_\+write(void $\ast$device, const u8 $\ast$buf, size\+\_\+t count)}]{\setlength{\rightskip}{0pt plus 5cm}int bt\+\_\+write (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{handle, }
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000007}{Bug}]the first byte is omitted for compatiblity with the leading report byte demanded by {\ttfamily hid\+\_\+write}. Wrapping H\+I\+D\+A\+P\+I could fix this. \begin{DoxySeeAlso}{See also}
implementation at \hyperlink{bt-win_8c}{bt-\/win.\+c} and \hyperlink{bt-unix_8c}{bt-\/unix.\+c} 
\end{DoxySeeAlso}
\end{DoxyRefDesc}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em handle} & handle returned by \hyperlink{bt-win_8c_a4926e3ba996c4e77d68845713a09db0c}{bt\+\_\+open()} \\
\hline
\mbox{\tt in}  & {\em buf} & byte string to write, the first byte is omitted \\
\hline
\mbox{\tt in}  & {\em count} & number of characters to be written (including leading ignored byte) \\
